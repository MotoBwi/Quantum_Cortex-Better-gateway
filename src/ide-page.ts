...
<body>
  ...
  <script>
    ...
    function normalizeWorkspaceRoot(path) {
      ...
      // Accept absolute workspace paths (e.g. /root/.Quantum_Cortex/workspace/projects/foo)
      const absWorkspacePrefix = '/root/.Quantum_Cortex/workspace/';
      if (normalized === '/root/.Quantum_Cortex/workspace') return '/';
